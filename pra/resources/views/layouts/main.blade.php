                ...
                <ul class="mobile-links mobile-links--level--0" data-collapse
                    ...
                    <li class="mobile-links__item" data-collapse-item>
                        <div class="mobile-links__item-title">
                            <a href="{{ route('display.home')}}" class="mobile-links__item-link">Home</a>
                        ...
                        <div class="mobile-header__body">
                            ...
                            <div class="mobile-header__indicators">
                                ...
                                <div class="indicator indicator--mobile d-sm-flex d-none">
                                    <a href="wishlist.html" class="indicator__button"><span
            ...
            <div class="site-header">
                                    ...
                                    @auth
                                        ...
                                        <div class="topbar-dropdown__body">
                                            ...
                                            <ul class="menu menu--layout--topbar">
                                                ...
                                                <li><a href="account.html">ChangePassword</a></li>
                                    ...
                                    @else
                                        ...
                                        <div class="topbar-dropdown__body">
                                            ...
                                            <ul class="menu menu--layout--topbar">
                                                ...
                                                <li><a href="{{ route('store.register')}}">Register</a></li>
                                                <li><a href="#">Orders</a></li>
                                            </ul>
                                            <!-- .menu / end -->
                                        </div>
                ...
                <div class="site-header__middle container">
                    ...
                    <div class="site-header__phone">
                        ...
                        <div class="site-header__phone-number">9811047217</div>
                    </div>
                </div>
                            ...
                            <div class="nav-panel__row">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="menu__submenu">
                                                                        ...
                                                                        <ul class="menu menu--layout--classic">
                                                                            ...
                                                                            <li>
                                                                                <a href="#">Gas Soldering
                                                                                    Iron</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#">Electric Soldering
                                                                                    Iron</a>
                                                                            </li>
                                                                        </ul>
                                                                        <!-- .menu / end -->
                                ...
                                <div class="nav-panel__nav-links nav-links">
                                    <ul class="nav-links__list">
                                        <li class="nav-links__item nav-links__item--with-submenu">
                                            <a href="{{ route('display.home')}}"><span>Home
                                                ...
                                                <ul class="menu menu--layout--classic">
                                                    <li>
                                                        ...
                                                        <div class="menu__submenu">
                                                            ...
                                                            <ul class="menu menu--layout--classic">
                                                                <li>
                                                                    <a href="shop-grid-3-columns-sidebar.html">3
                                                                        Columns Sidebar</a>
                                                                </li>
                                                                <li>
                                        ...
                                        <li class="nav-links__item">
                                            <a href="{{ route('display.product')}}"><span>All Product
                                                    </span></a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="nav-panel__indicators">
                                    ...
                                    <div class="indicator indicator--trigger--click">
                                        <a href="cart.html" class="indicator__button"><span
                                                class="indicator__area"><svg width="20px" height="20px">
                                                    <use xlink:href="images/sprite.svg#cart-20"></use>
                                                </svg>
                                                <span class="indicator__value">3</span></span></a>
                                                    ...
                                                    <div class="dropcart__product">
                                                        ...
                                                        <div class="dropcart__product-info">
                                                            <div class="dropcart__product-name">
                                                                <a href="product.html">Electric Planer Brandix
                                                                    KL370090G 300
                                                                    Watts</a>
                                                            </div>
